...
col_envi = hapit.loc[hapit['SITUACAO_RECEITA'] == '2 - ATIVA', [
   'NR_CNPJ', 'NM_CLIENTE', 'CELULAR_CONTATO_PRINCIPAL_SFA', 'SITUACAO_RECEITA', 'EMAIL_CONTATO_PRINCIPAL_SFA', 'NM_CONTATO_SFA', 'TLFN_1', 'TLFN_2', 'TLFN_3', 'TLFN_4', 'TLFN_5', 'TEL_COMERCIAL_SIEBEL', 'TEL_CELULAR_SIEBEL', 'TEL_RESIDENCIAL_SIEBEL']]
